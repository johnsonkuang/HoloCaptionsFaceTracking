...
namespace HoloToolkit.Unity
{
    public class CaptionController : Singleton<CaptionController>, InputModule.IInputClickHandler
    {
        ...
        //face coordinate
        public float[] faceCoordinate = new float[2];
        ...
        private void FrameProcessed(float[] landmarks, Matrix4x4 webcamToWorldTransform, bool resetModelFitter)
        {
            ...
            //update global variable with coordinates here
            faceCoordinate[0] = landmarks[0]; //x coord
            faceCoordinate[1] = landmarks[1]; //y coord
        }
